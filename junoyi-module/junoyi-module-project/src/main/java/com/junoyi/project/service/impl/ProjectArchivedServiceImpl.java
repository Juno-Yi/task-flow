...
import com.junoyi.project.mapper.ProjectArchivedMapper;
import com.junoyi.project.mapper.ProjectMemberMapper;
import com.junoyi.project.service.IProjectArchivedService;
...
public class ProjectArchivedServiceImpl implements IProjectArchivedService {

    private final ProjectArchivedMapper projectArchivedMapper;
     ...
     */
    @Override
    public PageResult<ProjectListVO> getArchivedList(ProjectListQueryDTO queryDTO, Page<Project> page) {
        // 获取当前用户ID
        ...
        // 分页查询项目列表
        Page<Project> resultPage = projectArchivedMapper.selectPage(page, wrapper);
