 ...
 */
@RestController
@RequestMapping("/project/archived")
@RequiredArgsConstructor
public class ProjectArchivedController extends BaseController {

    private final IProjectArchivedService projectArchivedService;
